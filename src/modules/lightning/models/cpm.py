...
class CPM(nn.Module):
    def __init__(self, 
        ...
        self.total_out = num_markers + num_joints
        self.num_stages = 6
        ...
        self.conv7_stage1 = nn.Conv2d(512, self.total_out, kernel_size=1)
        ...
        self.Mconv1_stage2 = nn.Conv2d(32 + self.total_out, 128, kernel_size=11, padding=5)
        ...
        self.Mconv5_stage2 = nn.Conv2d(128, self.total_out, kernel_size=1, padding=0)

        self.conv1_stage3 = nn.Conv2d(128, 32, kernel_size=5, padding=2)

        self.Mconv1_stage3 = nn.Conv2d(32 + self.total_out, 128, kernel_size=11, padding=5)
        ...
        self.Mconv5_stage3 = nn.Conv2d(128, self.total_out, kernel_size=1, padding=0)

        self.conv1_stage4 = nn.Conv2d(128, 32, kernel_size=5, padding=2)
        
        self.Mconv1_stage4 = nn.Conv2d(32 + self.total_out, 128, kernel_size=11, padding=5)
        ...
        self.Mconv5_stage4 = nn.Conv2d(128, self.total_out, kernel_size=1, padding=0)

        self.conv1_stage5 = nn.Conv2d(128, 32, kernel_size=5, padding=2)

        self.Mconv1_stage5 = nn.Conv2d(32 + self.total_out, 128, kernel_size=11, padding=5)
        ...
        self.Mconv5_stage5 = nn.Conv2d(128, self.total_out, kernel_size=1, padding=0)

        self.conv1_stage6 = nn.Conv2d(128, 32, kernel_size=5, padding=2)

        self.Mconv1_stage6 = nn.Conv2d(32 + self.total_out, 128, kernel_size=11, padding=5)
        ...
        self.Mconv5_stage6 = nn.Conv2d(128, self.total_out, kernel_size=1, padding=0)
    ...
    def forward(self, 
        ...
        full_unnormalized_heatmaps = conv7_stage1_map + Mconv5_stage2_map + Mconv5_stage3_map + Mconv5_stage4_map + Mconv5_stage5_map + Mconv5_stage6_map
        
        return full_unnormalized_heatmaps
