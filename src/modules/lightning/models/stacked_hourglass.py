...
__all__ = ["StackedHourglassMod"]

class StackedHourglassMod(torch.nn.Module):
    def __init__(self,
        ...
        super(StackedHourglassMod, self).__init__(
    ...
    def forward(self, 
        ...
        return aggregated_hm, torch.cat([x, aggregated_hm], dim=1)
